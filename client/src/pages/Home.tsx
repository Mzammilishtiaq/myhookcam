...
import { AnnotationSidebar } from "@/components/ui/annotation-sidebar";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FFFFFF]">
      {/* Header */}
      <header className="bg-[#555555] text-[#FFFFFF] p-4 shadow-md">
        <div className="container mx-auto flex justify-between items-center">
          <h1 className="text-xl font-semibold">
            <span className="text-[#FBBC05]">Video</span> Timeline Viewer
          </h1>
      ...
      <footer className="bg-[#BCBBBB] text-[#555555] p-3 text-sm text-center">
        <div className="container mx-auto">
          <p><span className="font-semibold">Video Timeline Viewer v1.0</span> | Connected to AWS S3 Storage</p>
        </div>
      </footer>
